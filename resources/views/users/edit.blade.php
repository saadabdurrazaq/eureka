        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input value="{{ old('phone') ? old('phone') : $user->phone }}"
                        class="form-control {{ $errors->first('phone') ? 'is-invalid' : '' }}" placeholder="Phone Number"
                ...
                <div class="col-md-6">
                    ...
                    <input value="{{ old('email') ? old('email') : $user->email }}"
                        class="form-control {{ $errors->first('email') ? 'is-invalid' : '' }}" placeholder="Phone Number"
                    ...
                    <select selected="selected" multiple
                        class="form-control {{ $errors->first('roles') ? 'is-invalid' : '' }}" name="roles[]"
                        id="roles"></select>
                    <div class="invalid-feedback">
                        {{ $errors->first('roles') }}
                    </div>
