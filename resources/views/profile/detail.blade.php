<form id="contact_us" method="post" action="{{ route('profile.show', ['id' => $users->id]) }}" class="form-horizontal"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{ old('name') ? old('name') : $users->name }}"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{ $users->username }}" disabled class="form-control" placeholder="username" type="text"
        ...
        <div class="col-sm-10">
            @if ($users->avatar == null)
                @if ($users->gender == 'Male')
                    <img src="{{ URL::asset('public/bower_components/admin-lte/dist/img/fb-male.jpg') }}" width="120px"
                        alt="User Image">
                @else
                    <img src="{{ URL::asset('public/bower_components/admin-lte/dist/img/female-fb.jpg') }}"
                        width="120px" alt="User Image">
                @endif
            @else
            ...
            <div class="form-group">
                <div class="file-loading">
                    <input id="avatar" type="file" name="file" multiple class="file" data-iconName="fa fa-upload"
